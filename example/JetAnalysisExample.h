...
public :
  ...
  JetAnalysisExample(TChain* tchain,const std::string& cfgFile="");
  virtual ~JetAnalysisExample();
  virtual Int_t    Cut(Long64_t entry);
  virtual Int_t    GetEntry(Long64_t entry);
  virtual Long64_t LoadTree(Long64_t entry);
  virtual void     Init(TTree *tree);
  virtual void     Loop(Long64_t nreq=0);
...
JetAnalysisExample::JetAnalysisExample(TTree *tree,Analysis::Config::Input::Selector inp) : fChain(0), _cfgFile(""), _cfgRead(false), _isDead(false)
{
