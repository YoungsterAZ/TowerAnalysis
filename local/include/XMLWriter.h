...
// Tue Feb  6 09:23:49 2018 by ROOT version 6.10/04
// from TTree CollectionTree/CollectionTree
// found on file: ../data/vbf2600_tower_tuple.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TChain if any.
   ...
   XMLWriter(TChain *tree=0);
   virtual ~XMLWriter();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TChain *tree);
   virtual void     Loop(const std::string& ofname="test.xml");
...
#ifdef XMLWRITER_CXX
XMLWriter::XMLWriter(TChain *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../data/vbf2600_tower_tuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../data/vbf2600_tower_tuple.root");
      }
...
Int_t XMLWriter::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t XMLWriter::LoadTree(Long64_t entry)
{
...
void XMLWriter::Init(TChain *tree)
{
...
void XMLWriter::Show(Long64_t entry)
{
...
Int_t XMLWriter::Cut(Long64_t entry)
{
